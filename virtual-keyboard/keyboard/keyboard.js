// main: refers to main kb element. keyContainer: keys container keys: array of all the buttons for keys
...
//runs when the page first loads/ initializes the kb
    init() { 
...
//private method/ will create all html for keys
    _createKeys() {
...
//     Keyboard.open("arms", function (currentValue) {
